    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="{{ route('dashboard') }}" class="flex mr-auto">
                ...
                <span class="hidden xl:block text-white text-lg ml-3"> Modification App </span>
            </a>
        ...
        <ul class="border-t border-theme-24 py-5 hidden">
            ...
            <li>
                <a href="{{ route('tasks') }}" class="menu <?php if($pagename==" tasks")echo 'menu--active' ; ?>">
                    <div class="menu__icon"> <i data-feather="layers"></i> </div>
                    <div class="menu__title"> Tasks </div>
                </a>
            </li>
            <li>
                <a href="{{ route('announced') }}" class="menu <?php if($pagename==" announced")echo 'menu--active' ; ?>">
                    <div class="menu__icon"> <i data-feather="users"></i> </div>
                    <div class="menu__title"> Announced</div>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="flex">
        ...
        <nav class="side-nav">
            ...
            <ul>
                ...
                <li>
                    <a href="{{route('tasks')}}" class="side-menu <?php if($pagename=='tasks')echo 'side-menu--active'; ?>">
                        <div class="side-menu__icon"> <i data-feather="layers"></i> </div>
                        <div class="side-menu__title"> Tasks </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('announced') }}"
                        class="side-menu <?php if($pagename=='announced')echo 'side-menu--active'; ?>">
                        <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                        <div class="side-menu__title"> Announced </div>
                    </a>
                </li>
            </ul>
        </nav>
